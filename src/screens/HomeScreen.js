  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.statsContainer}>
        <TouchableOpacity style={styles.statItem} onPress={() => navigation.navigate('Main', { screen: 'Profile' })}>
        ...
        <TouchableOpacity style={styles.statItem} onPress={() => navigation.navigate('Main', { screen: 'Lessons' })}>
